import { api } from "../api";
import { validateAndFilterShelters } from "../haversine";
...
export const shelterService = {
  ...
  /**
   * Automatically acquire user GPS, query nearest emergency shelters, and use Gemini AI
   * to assess safety, capacity, and recommend the best shelter.
   * @param {number} [userLat]
   * @param {number} [userLon]
   */
  async findSheltersWithGemini(userLat, userLon) {
    try {
      ...
      return {
        success: false,
        error: err.message || "Failed to query Gemini AI emergency shelter advisor",
      };
    }
  },
